...
modelL.add(constant([0]       ,[(.01,1.1)],"eps inf L"))
...
plot_model(modelT,omegas,rp,cp,2,.01,max_freq_to_analyze,title='Transverse')

plot_model(modelL,omegas,Ldatarp,Ldatacp,3,.001,max_freq_to_analyze,xscale='log',title='Longitudinal',longitudinal=True) 
plot_model(modelT,omegas,rp,cp,4,.05,max_freq_to_analyze,xscale='log',title='Transverse') 
